...
import { User, UserManager, type INavigator, type NavigateParams, type NavigateResponse, type StateStore } from "oidc-client-ts";
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const handleLogin = React.useCallback(async (url: string) => {
        setLoading(true);
        ...
        try {
            ...
            if (error instanceof Error && error.message === "No state in response") return;
